...
## 4. Verified state at close (15 Sep, the seventeenth session’s last fix — §0.134–§0.136 on dev, pushed and observed; §0.137 on dev, pushed, NOT observed, NOT shipped)
...
**Eighteenth-session prep — first (§0.137):**
