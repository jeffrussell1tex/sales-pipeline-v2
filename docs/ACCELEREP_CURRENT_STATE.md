...
completed pass. **Observed after the fix landed:** All 23 / Mine 5 —
the strict scope matching the dev org's known 5-owned + 18-unassigned
split exactly.
