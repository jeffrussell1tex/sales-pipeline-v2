...
- **Flagged, not done:** the plate row was not measured live (the pane had signed out) — the scan is the proof until he looks; §0.136’s remaining 140 off-brand literals in 18 files; §0.134’s rep path as Karen.
