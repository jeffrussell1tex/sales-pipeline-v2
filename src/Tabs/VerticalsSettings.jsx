                                ...
                                <div key={v.id} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', background: '#fff', border: '1px solid #e2e8f0', borderRadius: '8px' }}>
                                    {editingId === v.id ? (
                                        <>
                                            ...
                                            <button onClick={() => saveEdit(v.id)} style={{ padding: '4px 10px', borderRadius: '999px', border: 'none', background: '#1c1917', color: '#f5f1eb', fontWeight: '500', fontSize: '0.6875rem', cursor: 'pointer', fontFamily: 'inherit' }}>Save</button>
