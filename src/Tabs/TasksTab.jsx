...
function SourceBadge({ source }) {
    if (source === 'log') return (
        <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: 0.6, textTransform: 'uppercase', color: T.goldInk, background: 'rgba(200,185,154,0.22)', padding: '2px 6px', borderRadius: 999, lineHeight: 1.2, flexShrink: 0 }}>Logged</span>
    );
    if (source === 'task-completed') return (
        <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: 0.6, textTransform: 'uppercase', color: T.ok, background: 'rgba(77,107,61,0.10)', padding: '2px 6px', borderRadius: 999, lineHeight: 1.2, flexShrink: 0 }}>Task done</span>
    );
    return null;
}
        ...
        >
            ...
            <div style={{ minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {task.autoGenerated && <span style={{ fontSize: 9, fontWeight: 700, color: T.goldInk, background: 'rgba(200,185,154,0.2)', padding: '1px 5px', borderRadius: 999, border: `1px solid ${T.gold}`, letterSpacing: 0.5 }}>AUTO</span>}
                </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, paddingTop: 2, flexShrink: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 3, minWidth: 60 }}>
                    ...
                    {isOverdue && (
                        <span style={{ fontSize: 10, background: 'rgba(156,58,46,0.08)', color: T.danger, padding: '1px 5px', borderRadius: 999, fontWeight: 700, letterSpacing: 0.4, textTransform: 'uppercase', whiteSpace: 'nowrap' }}>Overdue</span>
                    )}
                    {!isOverdue && isHigh && (
        ...
        >
            ...
            <div style={{ minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    {task.autoGenerated && <span style={{ fontSize: 9, fontWeight: 700, color: T.goldInk, background: 'rgba(200,185,154,0.2)', padding: '1px 5px', borderRadius: 999, letterSpacing: 0.5 }}>AUTO</span>}
                </div>
                <div style={{ fontSize: 11.5, color: T.inkMid, marginTop: 3, display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
