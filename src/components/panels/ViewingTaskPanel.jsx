...
export default function ViewingTaskPanel({
    ...
    }[status] || { bg: 'rgba(58,90,122,0.1)', color: '#2a2622' };
        ...
        >
            ...
            >
                <div style={{ minWidth: 0, flex: 1 }}>
                    <h2 style={{ margin: 0, fontSize: '1.0625rem', fontWeight: '700', color: '#fbf8f3', userSelect: 'none', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {t.title}
                    </h2>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexShrink: 0, marginLeft: '1rem' }}>
                    ...
                    <button
                        ...
                        style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '6px', width: '28px', height: '28px', cursor: 'pointer', fontSize: '1rem', color: '#fbf8f3', lineHeight: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'inherit' }}
                    >×</button>
                </div>
            </div>
            ...
            <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: '1.25rem 1.5rem', overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch' }}>
                ...
                {t.description && (
                    <div style={{ padding: '0.75rem 1rem', background: '#fbf8f3', borderRadius: '6px', marginBottom: '1rem', fontSize: '0.875rem', color: '#5a544c', lineHeight: 1.5 }}>
                        {t.description}
                    </div>
                )}

                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '1.25rem' }}>
                    <div style={{ padding: '0.625rem 0.75rem', background: '#fbf8f3', borderRadius: '6px' }}>
                        <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Due Date</div>
                        <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#2a2622' }}>
                            {t.dueDate
                    ...
                    {t.completedDate && (
                        <div style={{ padding: '0.625rem 0.75rem', background: 'rgba(77,107,61,0.07)', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Completed</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#2e4a24' }}>
                    ...
                    {relatedOpp && (
                        <div style={{ padding: '0.625rem 0.75rem', background: '#fbf8f3', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Opportunity</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#3a5a7a' }}>
                    ...
                    {relatedContact && (
                        <div style={{ padding: '0.625rem 0.75rem', background: '#fbf8f3', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Contact</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#2a2622' }}>
                    ...
                    {relatedAccount && (
                        <div style={{ padding: '0.625rem 0.75rem', background: '#fbf8f3', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Account</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#2a2622' }}>
                                {relatedAccount.name}
                            </div>
                        </div>
                    ...
                    {t.assignedTo && (
                        <div style={{ padding: '0.625rem 0.75rem', background: '#fbf8f3', borderRadius: '6px' }}>
                            <div style={{ fontSize: '0.6875rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Assigned To</div>
                            <div style={{ fontSize: '0.875rem', fontWeight: '600', color: '#2a2622' }}>
                                {t.assignedTo}
                            </div>
                        </div>
                ...
                {taskActivities.length > 0 && (
                    <div>
                        <div style={{ fontSize: '0.75rem', fontWeight: '700', color: '#8a8378', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>
                        ...
                        <div style={{ border: '1px solid #e6ddd0', borderRadius: '8px', overflow: 'hidden' }}>
                            {taskActivities.map((a, idx) => (
                                <div key={idx} style={{ display: 'flex', gap: '0.625rem', padding: '0.5rem 0.75rem', borderBottom: idx < taskActivities.length - 1 ? '1px solid #f1f3f5' : 'none', fontSize: '0.8125rem', alignItems: 'center', background: idx % 2 === 0 ? '#fff' : '#fbf8f3' }}>
            ...
            {/* ── Footer actions ── */}
            <div style={{ padding: '0.875rem 1.5rem', borderTop: '1px solid #e6ddd0', display: 'flex', gap: '0.5rem', justifyContent: 'flex-end', flexShrink: 0, background: '#fbf8f3' }}>
