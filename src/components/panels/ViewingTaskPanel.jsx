...
export default function ViewingTaskPanel({
    ...
    const {
        ...
        logFromCalLoading, logFromCalError,
    ...
    const handleEditAccount = (a, isSub = false) => { if (isSub) { setEditingSubAccount(a); setEditingAccount(null); } else { setEditingAccount(a); setEditingSubAccount(null); } setShowAccountModal(true); };
