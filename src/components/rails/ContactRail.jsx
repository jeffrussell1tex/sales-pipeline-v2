            ...
            <div style={{ flex: 1, overflowY: 'auto', minHeight: 0, padding: '14px 18px' }}>
                ...
                {dupWarning && (
                    <div style={{ background: `${T.warn}18`, border: `1px solid ${T.warn}40`, borderRadius: T.r, padding: '10px 12px', marginBottom: 12 }}>
                        <div style={{ fontWeight: 700, color: T.warn, fontSize: 12, marginBottom: 4 }}>⚠ Possible duplicate{dupWarning.length > 1 ? 's' : ''} found</div>
                        {dupWarning.slice(0, 3).map(d => (
                            <div key={d.id} style={{ fontSize: 12, color: T.warn, marginBottom: 2 }}>
