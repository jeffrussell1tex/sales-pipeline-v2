...
export default function AccountModal({ account, isSubAccount, settings, onClose, onSave, onAddRep, existingAccounts }) {
...
// ── ViewingBar ─────────────────────────────────────────────────────
// Shared "Viewing:" bar rendered inside Home / Pipeline / Opportunities / Tasks tabs.
// Includes a Pipeline dropdown (when multiple pipelines exist) plus Rep/Team/Territory
// slicers (managers/admins only). All selections are single-select; choosing one clears
// the others. Identical to the Analytics & Reports Viewing bar in style.
