...
export default function LeadImportModal({ onClose, onImport, existingLeads = [] }) {
    ...
    const modal    = { background:'#fff', borderRadius:'14px', width:'100%', maxWidth:'680px', maxHeight:'90vh', display:'flex', flexDirection:'column', boxShadow:'0 20px 60px rgba(0,0,0,0.2)', ...dragOffsetStyle };
    const hdr      = { ...dragHandleProps.style, padding:'1rem 1.25rem', borderBottom:'1px solid #e2e8f0', display:'flex', alignItems:'center', justifyContent:'space-between', flexShrink:0 };
    ...
    return (
        <div style={overlay} onClick={e => e.target===e.currentTarget && onClose()}>
            <div style={modal}>
                {/* Header */}
                <div style={hdr} onMouseDown={dragHandleProps.onMouseDown}>
                    <div>
