...
export default function ContactModal({ contact, contacts, accounts, settings, onClose, onSave, onSaveNewContact, onAddAccount }) {
            ...
            <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '650px' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="modal-actions">
                        ...
                        <button type="submit" className="btn">{contact ? 'Update' : 'Create'}</button>
                    </div>
                </form>
            </div>
