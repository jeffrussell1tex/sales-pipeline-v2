...
// The §0.148 PriceBookDetail money-face test is gone with the file (§0.149): the
// Settings panel edited a demo list nothing read; the price book is Quotes → Price Book.
